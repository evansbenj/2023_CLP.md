...
```
Now genotype the other large chromsomes using a bed file:
```
sbatch 2021_HaplotypeCaller_onebam_onechr.sh ../cliv_ref/GCA_046118455.1_ASM4611845v1_genomic.fa ../2024_cliv/rg_bamz/fem_CAS260390_all_sorted.bam_rg.bam cliv_14_to_19.bed
```
